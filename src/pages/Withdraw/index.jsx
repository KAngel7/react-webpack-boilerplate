      ...
      <div className="styles_body__2t5HW  styles_haveFooter__2fJ9r">
        <div className="styles_main__21Z6r" id="p-wallets">
          ...
          <div className="styles_body__tAox4">
            <div className="styles_container__2kE2g styles_main__2JYNV">
              <h2 className="styles_header__32ZxQ">Withdrawals</h2>
              <div className="styles_main__1zpdt  grd-v">
                <div className="styles_body__2xX5a ">
                  <div className="styles_main__1hi71">
                    <div className="styles_item__1h6F2">
                    ...
                    <div className="styles_item__1h6F2">
                      <div className="styles_wrapperBalance__1TWd0">
                        <span className="styles_balanceTitle__EVoSG">
                          Available BTC
                        </span>
                        <span className="styles_balanceValue__1N1Cr">
                          <span
                            className="styles_main__3UZrp"
                            title={0.0}
                            id="p-wallets--body--free-balance"
                            data-value={0}
                          >
                            0.
                            <span
                              id="p-wallets--body--free-balance--zeros"
                  ...
                  <div className="styles_top__LbRya">
                    <span id="p-wallets--body--top-BTC">
                    ...
                    <h4 className="styles_currency__3UXvm">BTC</h4>
                  </div>
                  <div className="styles_section__1STX4">
                    <div className="styles_main__1CYcb grd-v">
                      <section>
                        <h3 className="styles_title__3OaIu">
                          Withdraw to your wallet
                        </h3>
                        <div className="styles_body__3-YJg">
                          <h6 className="styles_title2__1ajG0">
                            Step 1. Whitelist your BTC address
                          </h6>
                          <p className="styles_helper2__1bi6q">
                            Confirm your withdrawal address before creating the
                            request. It will only take a minute and you only
                            have to do it once.
                          </p>
                          <h6 className="styles_title2__1ajG0">
                            Step 2. Create the withdrawal request
                          </h6>
                          <hr className="styles_hr__cPEzk" />
                          <p className="styles_helper__17ufk">
                            You will receive an email notification when the
                            transaction is executed.
                          </p>
                        </div>
                        <div className="styles_control__ReG0m">
                          <button
                            type="button"
                            id="withdrawal-crypto--fund-2"
                            className="styles_main__1rTEz styles_large__3mDiO styles_outline-primary__a2hOw styles_btnBig__v3GSn"
                          >
                            Get Started
                          </button>
                        </div>
              ...
              <div className="styles_main__1zpdt  grd-v">
                <div className="styles_body__2xX5a styles_body__1M21N">
                  <h4 className="styles_title__LP6aA">
                    Withdrawal Requests<span>|</span>BTC
                  </h4>
                  <div className="styles_wrapperList__1Ftmm">
                    <div className="styles_list__1-DRY">
                      <div>
                        <div className="styles_main__26IVR styles_main__1RMfl">
                          <div
                            id="p-wallets--body--pending-list--header--id"
                            data-value="id"
                            role="button"
                            tabIndex={-1}
                            className="styles_item__1zu0w styles_id__3lSco"
                          >
                            ID
                          </div>
                          <div
                            id="p-wallets--body--pending-list--header--amount"
                            data-value="amount"
                            role="button"
                            tabIndex={-1}
                            className="styles_item__1zu0w styles_amount__Nx3i_"
                          >
                            Amount
                          </div>
                          <div
                            id="p-wallets--body--pending-list--header--fee"
                            data-value="fee"
                            role="button"
                            tabIndex={-1}
                            className="styles_item__1zu0w styles_fee__1g8Z9"
                          >
                            Fee
                          </div>
                          <div
                            id="p-wallets--body--pending-list--header--address"
                            data-value="address"
                            role="button"
                            tabIndex={-1}
                            className="styles_item__1zu0w styles_address__3lXvD"
                          >
                            Address
                          </div>
                          <div
                            id="p-wallets--body--pending-list--header--status"
                            data-value="status"
                            role="button"
                            tabIndex={-1}
                            className="styles_item__1zu0w styles_status__2NesC"
                          >
                            Status
                          </div>
                          <div
                            id="p-wallets--body--pending-list--header--created"
                            data-value="created"
                            role="button"
                            tabIndex={-1}
                            className="styles_item__1zu0w styles_created__WwpYy"
                          >
                            Created On
                          </div>
                          <div
                            id="p-wallets--body--pending-list--header--cancel"
                            data-value="cancel"
                            role="button"
                            tabIndex={-1}
                            className="styles_item__1zu0w styles_cancel__1jnah"
                          >
                            Cancel
                          </div>
                        </div>
                        <div id="p-wallets--body--pending-list--models" />
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="styles_main__1zpdt  grd-v">
                <div className="styles_body__2xX5a styles_body__1M21N">
                  <h4 className="styles_title__LP6aA">
                    Completed Withdrawals<span>|</span>BTC
                  </h4>
                  <div className="styles_wrapperList__1Ftmm">
                    <div className="styles_list__1-DRY">
                      <div>
