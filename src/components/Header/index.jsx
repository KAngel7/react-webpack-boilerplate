...
const Header = () => (
  <header className="css-1ytimvi">
    ...
    <a href="/register" className="css-p93cyt">
      <button type="button" id="header_register" className="css-yotb4s">
        Đăng ký
      </button>
    </a>
    <div className="css-109r71v">
      <div className="hoverstatus css-g44r5b">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="css-1mhvr59"
          fill="currentColor"
        >
          <use xlinkHref="#icon-h-download"></use>
        </svg>
      </div>
    </div>
  </header>
